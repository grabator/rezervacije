...
public static class SeedData
{
    public static void EnsureSeeded(AppDbContext db)
    {
        ...
        [
            ("S1", 71, 165, 45, 4, "square", "free"),
            ("S2", 72, 246, 45, 3, "square", "free"),
            ("S3", 71, 340, 45, 3, "square", "taken"),
            ("S4", 71, 294, 43, 3, "square", "free"),
            ("S5", 280, 143, 45, 4, "square", "free"),
            ("S6", 426, 194, 47, 4, "round", "pending"),
            ("S7", 492, 194, 52, 4, "round", "free"),
            ("S8", 567, 193, 52, 4, "round", "free"),
            ("S9", 639, 192, 52, 4, "round", "taken"),
            ("S10", 734, 227, 50, 4, "round", "free"),
            ("S11", 355, 350, 52, 4, "round", "free"),
            ("S12", 460, 350, 52, 4, "round", "free"),
            ("S13", 583, 351, 52, 4, "round", "taken"),
            ("S14", 718, 353, 52, 4, "round", "free"),
            ("S15", 258, 219, 45, 4, "square", "free"),
            ("S16", 69, 435, 52, 4, "round", "free"),
            ("S17", 70, 505, 52, 4, "round", "free"),
            ("S18", 269, 425, 52, 4, "round", "free"),
            ("S19", 371, 426, 52, 4, "round", "pending"),
            ("S20", 481, 427, 52, 4, "round", "free"),
            ("S21", 578, 428, 52, 4, "round", "free"),
            ("S22", 269, 511, 52, 4, "round", "free"),
            ("S23", 371, 510, 52, 4, "round", "free"),
            ("S24", 476, 514, 52, 4, "round", "taken"),
            ("S25", 573, 514, 52, 4, "round", "free"),
            ("S26", 668, 514, 52, 4, "round", "free"),
            ("S27", 666, 429, 52, 4, "round", "free"),
        ];
