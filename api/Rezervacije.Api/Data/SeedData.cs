...
public static class SeedData
{
    public static void EnsureSeeded(AppDbContext db)
    {
        ...
        var ev2 = new VenueEvent
        {
            Id = "njemacka-spanija",
            VenueId = venue.Id,
            Title = "Njemačka vs Španija",
            Subtitle = "Utakmica na velikim ekranima",
            StartsAt = new DateTime(2026, 9, 29, 20, 45, 0, DateTimeKind.Unspecified),
            FloorWidth = 980,
            FloorHeight = 715,
        };
        ...
        AddFloorPlan(db, ev1.Id, withReservedTables: true);
        AddFloorPlan(db, ev2.Id, withReservedTables: false);
    ...
    private static void AddFloorPlan(AppDbContext db, string eventId, bool withReservedTables)
    {
        ...
        db.FloorElements.AddRange(
            ...
            new FloorElementEntity { EventId = eventId, Kind = "label", X = 405, Y = 30, W = 176, H = 116, Text = "WC" },
            new FloorElementEntity { EventId = eventId, Kind = "tv", X = 14, Y = 464, W = 158, H = 24, Text = null },
            new FloorElementEntity { EventId = eventId, Kind = "entrance", X = 235, Y = 468, W = 45, H = 25, Text = "Ulaz" },
            new FloorElementEntity { EventId = eventId, Kind = "label", X = 241, Y = 160, W = 75, H = 44, Text = "Igrice" },
            new FloorElementEntity { EventId = eventId, Kind = "label", X = 834, Y = 270, W = 51, H = 76, Text = "Igrice" },
            new FloorElementEntity { EventId = eventId, Kind = "tv", X = 385, Y = 386, W = 20, H = 88, Text = null },
            new FloorElementEntity { EventId = eventId, Kind = "tv", X = 669, Y = 395, W = 21, H = 83, Text = null },
            new FloorElementEntity { EventId = eventId, Kind = "entrance", X = 5, Y = 496, W = 945, H = 3, Text = "" },
            new FloorElementEntity { EventId = eventId, Kind = "label", X = 626, Y = 26, W = 309, H = 129, Text = null },
            new FloorElementEntity { EventId = eventId, Kind = "sofa", X = 476, Y = 174, W = 468, H = 33, Text = null },
            new FloorElementEntity { EventId = eventId, Kind = "entrance", X = 234, Y = 646, W = 45, H = 25, Text = "Bašta" },
            new FloorElementEntity { EventId = eventId, Kind = "tv", X = 918, Y = 515, W = 24, H = 125, Text = null },
            new FloorElementEntity { EventId = eventId, Kind = "label", X = 308, Y = 365, W = 51, H = 118, Text = null },
            new FloorElementEntity { EventId = eventId, Kind = "label", X = 246, Y = 214, W = 115, H = 15, Text = null },
            new FloorElementEntity { EventId = eventId, Kind = "label", X = 388, Y = 156, W = 13, H = 74, Text = null }
        );
        ...
        [
            ...
            ("S3", 89, 425, 56, 3, "square", withReservedTables ? "taken" : "free"),
            ("S4", 89, 368, 54, 3, "square", "free"),
            ("S5", 350, 179, 56, 4, "square", "free"),
            ("S6", 533, 243, 59, 4, "round", withReservedTables ? "pending" : "free"),
            ("S7", 615, 243, 65, 4, "round", "free"),
            ("S8", 709, 241, 65, 4, "round", "free"),
            ("S9", 799, 240, 65, 4, "round", withReservedTables ? "taken" : "free"),
            ("S10", 918, 284, 63, 4, "round", "free"),
            ("S11", 444, 438, 65, 4, "round", "free"),
            ("S12", 575, 438, 65, 4, "round", "free"),
            ("S13", 729, 439, 65, 4, "round", withReservedTables ? "taken" : "free"),
